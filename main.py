...
while not endTheGame:
    ...
    while gameOver and not endTheGame: # game over
        ...
        writeSomething("Roboto", 36, f"Enemies Destroyed: {enemyGenerator.numberOfAnyEnemiesKilled}", (255,255,255), 5, 5, screen)
        writeSomething("Roboto", 36, 'Press "Esc" to exit the game', (255,255,255), 5, screenHeight - 30, screen)
        pygame.display.update()
        clock.tick(fps)
pygame.quit()